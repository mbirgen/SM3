...
`r detex_index_entry('C', 'descriptive statistics!computing|(')` 
...
inches).
`r detex_index_entry('P', 'Descriptive Statistics!mean@mean')` 
`r detex_index_entry('P', 'Descriptive Statistics!sd@sd')` 
`r detex_index_entry('P', 'Descriptive Statistics!median@median')` 
`r detex_index_entry('P', 'mean@mean')` 
`r detex_index_entry('P', 'median@median')` 
`r detex_index_entry('P', 'sd@sd')` 
`r detex_index_entry('P', 'var@var')` 
`r detex_index_entry('C', 'variance!sqrt of standard deviation')` 
...
Why the tilde?  In all these commands the first argument (` ~ height`) is recognized by the interpreter as a `r detex::new_word("model formula")`.  Model language involves the tilde, and the tilde must be followed by a variable.
...
`r detex_index_entry('P', 'Descriptive Statistics!pdata@pdata')` 
`r detex_index_entry('P', 'Descriptive Statistics!qdata@qdata')` 
`r detex_index_entry('C', 'percentile!quantile operator')` 
`r detex_index_entry('P', 'quantile@quantile')` 
`r detex_index_entry('P', 'qdata@qdata*')` 
`r detex_index_entry('P', 'pdata@pdata*')`
...
`r detex_index_entry('C', 'quantiles!and coverage intervals')` 
`r detex_index_entry('C', 'coverage interval!quantiles')` 
...
`range()`.  
`r detex_index_entry('P', 'min@min')` 
`r detex_index_entry('P', 'max@max')` 
`r detex_index_entry('P', 'range@range')` 
...
`r detex_index_entry('C', 'graphics!statistical' )`
`r detex_index_entry('C', 'statistical graphics' )`
...
`r detex_index_entry('C', 'histogram!drawing')` 
`r detex_index_entry('P', 'histogramhistogram')` 
`r detex_index_entry('P', 'Plotting & Graphics!histogram@histogram')` 
...
`r detex_index_entry('P', 'densityplot@densityplot')` 
`r detex_index_entry('P', 'Plotting & Graphics!densityplot@densityplot')` 

`r detex_index_entry('C', 'density plot!drawing')` 
...
`r detex_index_entry('C', 'outlier!in box plots')` 
`r detex_index_entry('C', 'box plot!outliers')` 
`r detex_index_entry('C', 'box plot!drawing')` 
`r detex_index_entry('P', 'bwplot@bwplot')` 
`r detex_index_entry('P', 'Plotting & Graphics!bwplot@bwplot')` 
`r detex_index_entry('C', 'box and whisker plots|see{box plots}')` 
...
`r detex_index_entry('C', 'counts!computing')` 
`r detex_index_entry('C', 'proportions!computing')` 
`r detex_index_entry('P', 'counts@counts')` 
`r detex_index_entry('P', 'props@props')` 
`r detex_index_entry('P', 'Descriptive Statistics!props@props')` 
`r detex_index_entry('C', 'table!of counts')` 
