...
`r detex_index_entry('P', 'Confidence Intervals')` 
...
`r detex_index_entry('C', 'confidence interval!computation')` 
`r detex_index_entry('P', 'confint@confint')` 
`r detex_index_entry('P', 'Confidence Intervals!confint@confint')` 
...
`r detex_index_entry('C', 'confidence interval!for prediction')` 
`r detex_index_entry('C', 'prediction!confidence interval')` 
...
`r detex_index_entry('P', 'predict@predict')` 
`r detex_index_entry('P', 'Modeling!predict@predict')` 
...
`r detex_index_entry('P', 'interval@interval=!in predict')` 
`r detex_index_entry('P', 'Confidence Intervals!interval@interval=!in predict')` 
