...
`r detex_index_entry('C', 'resampling')` 
`r detex_index_entry('P', 'resample@resample*')` 
`r detex_index_entry('P', 'Resampling!resample@resample*')` 
`r detex_index_entry('C', 'coin flip!simulation')` 
`r detex_index_entry('P', 'Simulations!coin flip')` 
...
`r detex_index_entry('C', 'probability model!sampling from')` 
...
`r detex_index_entry('P', 'rnorm@rnorm')` 
`r detex_index_entry('P', 'runif@runif')` 
`r detex_index_entry('P', 'rpois@rpois')` 
`r detex_index_entry('P', 'rexp@rexp')` 
`r detex_index_entry('P', 'rlnorm@rlnorm')` 
`r detex_index_entry('P', 'rchisq@rchisq')` 
`r detex_index_entry('P', 'rf@rf')` 
`r detex_index_entry('P', 'rt@rt')` 
`r detex_index_entry('P', 'rbinom@rbinom')` 
`r detex_index_entry('P', 'Probability!random generators')` 
...
`r detex_index_entry('C', 'coverage interval!computing')` 
...
`r detex_index_entry('C', 'coverage interval!level')` 
...
`r detex_index_entry('P', 'quantiles!q-functions')` 
`r detex_index_entry('P', 'Probability!q operators')` 
`r detex_index_entry('C', 'quantiles!computing')` 
...
`r detex_index_entry('P', 'percentile!p-functions')` 
`r detex_index_entry('C', 'percentile!computing')` 
`r detex_index_entry('P', 'Probability!p operators')` 
`r detex_index_entry('P', 'Probability!q operators')` 
