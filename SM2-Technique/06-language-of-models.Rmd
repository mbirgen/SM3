...
`r detex_index_entry('C', 'graphics!two-variable')` 
`r detex_index_entry('C', 'scatter plot')` 
`r detex_index_entry('P', 'scatter plots, making')` 
`r detex_index_entry('P', 'Plotting \\& Graphics!xyplot@xyplot')` 
`r detex_index_entry('P', 'xyplot@xyplot')` 
...
`r detex_index_entry('P', 'data@data = in lm')` 
`r detex_index_entry('P', 'Data!data@data = in lm')` 
`r detex_index_entry('P', 'Modeling!data@data = in lm')` 
...
`r detex_index_entry('C', 'graphics!axis labels')` 
`r detex_index_entry('C', 'axis (in graphics)!labels')` 
`r detex_index_entry('P', 'xlab@xlab= for axis label')` 
`r detex_index_entry('P', 'ylab@ylab= for axis label')` 
`r detex_index_entry('P', 'Plotting \\& Graphics!xlab@xlab= \\& ylab=')` 
...
`r detex_index_entry('P', 'Plotting \\& Graphics!axis limits')` 
`r detex_index_entry('C', 'graphics!axis limits')` 
`r detex_index_entry('C', 'axis (in graphics)! limits in graphics')` 
`r detex_index_entry('P', 'xlim@xlim= for axis limits')` 
`r detex_index_entry('P', 'ylim@ylim= for axis limits')` 
...
`r detex_index_entry('P', 'key in graphics, auto.key=')` 
`r detex_index_entry('P', 'auto.key@auto.key=')` 
`r detex_index_entry('C', 'Plotting \\& Graphics!adding a key')` 
```{r}
...
`r detex_index_entry('C', 'graphics!multiple variables')` 
...
`r detex_index_entry('C', 'fitting!lm@lm operator')` 
`r detex_index_entry('C', 'model fitting!lm@lm operator')` 
...
`r detex_index_entry('C', 'transformation terms')` 
`r detex_index_entry('P', 'I for transformation terms@I for transformation terms')` 
`r detex_index_entry('P', 'Modeling!I@I for transformation terms')` 
