...
`r detex_index_entry('P', 'shuffle@shuffle*')` 
`r detex_index_entry('P', 'Hypothesis Testing!resample@resample*')` 
`r detex_index_entry('P', 'Hypothesis Testing!shuffle@shuffle*')` 

`r detex_index_entry('P', 'Resampling!resample@resample*')` 
`r detex_index_entry('P', 'Resampling!shuffle@shuffle*')` 
`r detex_index_entry('C', 'permutation test!computing')` 
...
`r detex_index_entry('C', 'regression report!hypothesis testing')` 
`r detex_index_entry('C', 'hypothesis testing!in regression report')`
...
`r detex_index_entry('P', 'summary@summary!for linear models')` 
`r detex_index_entry('P', 'Hypothesis Testing!summary@summary!for linear models')` 
...
1 - pf( 574.2, 2, 895)
```
`r detex_index_entry('P', 'pf@pf')` 
`r detex_index_entry('P', 'Hypothesis Testing!pf@pf')` 
`r detex_index_entry('C', 'p value!from F statistic')` 
