...
remotes::install_github("dtkaplan/detex")
library(detex)
```
...
computers for scientific and statistical work, so the first chapters
...
a good idea for you to use parenthesis so that you can make sure that
...
notation, this would be written `G=6.67428e-11`. The Avogadro constant, which gives the number of atoms in a mole, is $6.02214179
