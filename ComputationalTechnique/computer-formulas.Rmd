...
`r detex::index_entry('C', 'coefficients!computing best fitting')` 
To illustrate,
...
`r detex::index_entry('P', 'coef@coef')` 
`r detex::index_entry('P', 'Modeling!coef@coef')` 
...
operator. 
`r detex::index_entry('P', 'summary@summary!for lm')` 
`r detex::index_entry('P', 'Modeling@regression report with summary')` 
`r detex::index_entry('P', 'Regression report with summary')` 
`r detex::index_entry('C', 'regression report!computing')` 
...
`r detex::index_entry('C', 'model value!calculating')` 
...
`r detex::index_entry('C', 'interaction term!computing model values')` 
```{r}
...
`r detex::index_entry('P', 'cross@cross*')` 
`r detex::index_entry('P', 'Data!cross@cross*')` 
`r detex::index_entry('C', 'crossing categorical variables')` 
`r detex::index_entry('C', 'categorical variable!crossing')` 
#. `cross()` will combine two categorical variables into a single
...
`r detex::index_entry('P', 'as.factor@as.factor')` 
`r detex::index_entry('P', 'Data!as.factor@as.factor')` 
`r detex::index_entry('C', 'categorical variable!from quantitative')` 
`r detex::index_entry('C', 'quantitative variable!to categorical')` 
#. `as.factor()` will convert a quantitative variable to a categorical
