...
`r detex::index_entry('C', 'sum of squares!computing')` 
...
`r detex::index_entry('C', 'partitioning!sums of squares')` 
`r detex::index_entry('C', 'sum of squares!partitioning')` 
...
`r detex::index_entry('C', 'scientific notation')` 
`r detex::index_entry('C', 'zero')` 


## Redundancy

`r detex::index_entry('C', 'redundancy!and NA')` 
`r detex::index_entry('C', 'coefficients!NA (redundancy)')` 
...
`r detex::index_entry('C', 'redundancy!fitted model values')` 
...
`r detex::index_entry('C', 'redundancy!in categorical variables')` 
